...
github_user <- 'jbryer'
github_repo <- "IS381-2025-Fall"
one_minute_paper <- 'https://forms.gle/N8WjTAysfKbGLptLA'
one_minute_paper_results <- 'https://docs.google.com/spreadsheets/d/1Em140z8x9i_9gZMtwzwJmnoaLhq-SNvkiHI049vJ5QU/edit?resourcekey=&gid=1885914668#gid=1885914668'
formative_assessment <- 'https://forms.gle/sXrP9X7ZK2dXv2Lu6'
formative_assessmnet_results <- 'https://docs.google.com/spreadsheets/d/14nNcQXgmjItj7h2WiKw2MTL_9atAqV3z1-2GUFuWY2I/edit?resourcekey=&gid=2144187664#gid=2144187664'
slack_invite_link <- 'https://cuny-msds.slack.com/archives/C09B31HKH9C'
